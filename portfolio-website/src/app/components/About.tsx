  ...
  const education = [
    {
      ...
      description:
        "Specialized in software development methodologies, algorithms, and system design. Completed projects in web development, mobile applications, and database management.",
    },
    {
      ...
      description:
        "Fundamentals of programming, networking, and system administration. Gained hands-on experience with various programming languages and development tools.",
    },
  ];
  ...
  const workExperience = [
    {
      ...
      description:
        "Developing responsive web applications using React.js and Next.js. Collaborating with backend teams to integrate RESTful APIs and improve user experience.",
    ...
    <div>
      ...
      <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed text-justify">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-16 border-cyan-500/20">
          ...
          {/* Work Experience Block - Updated to match Education style */}
          <LampContainer className="border rounded-2xl  border-gray-200 dark:border-gray-700">
            <motion.div
              initial={{ opacity: 0.5, y: 100 }}
              whileInView={{ opacity: 1, y: 0 }}
